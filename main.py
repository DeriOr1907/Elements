...
def level1(red,blue,pink,purple,RED,BLUE,PINK,PURPLE):
    ...
    while run:
        ...
        lavas = [green_lava1, green_lava2, green_lava3, green_lava4, green_lava5, girl_lava1, boy_lava1]
        diamonds = [girl_diamond1, girl_diamond2, girl_diamond3, girl_diamond4, girl_diamond5, boy_diamond1,
                    boy_diamond2,
